...
pub fn document() -> serde_json::Value {
    ...
    }
    {
        ...
        builder = builder.component_schema("LoginResp", Schema::object(properties, vec!["token".to_string()]));
    }
    {
        let mut properties = BTreeMap::new();
        properties.insert("id".to_string(), Schema::integer("int64"));
        builder = builder.component_schema("GetUserReq", Schema::object(properties, vec!["id".to_string()]));
    }
    {
        let mut properties = BTreeMap::new();
        properties.insert("id".to_string(), Schema::integer("int64"));
        ...
        builder = builder.component_schema("UserResp", Schema::object(properties, vec!["id".to_string(), "username".to_string(), "created_at".to_string()]));
    }
    ...
    let op = Operation::new("getUser").tag("user-api").parameter("id", roze_openapi::ParameterLocation::Path, "i64", true).response("200", "OK", "UserResp");
