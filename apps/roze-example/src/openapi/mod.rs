...
pub fn document() -> serde_json::Value {
    ...
    builder.add_operation("/reports/exports", HttpMethod::Post, op);
    ...
    builder.add_operation("/reports/exports/{id}", HttpMethod::Get, op);
    let op = Operation::new("cancelReportExport")
        .summary("Cancel a report export")
        .tag("user-api")
        .parameter("id", roze_openapi::ParameterLocation::Path, "String", true)
        .response("200", "OK", "ReportExportResource");
    builder.add_operation("/reports/exports/{id}", HttpMethod::Delete, op);
    ...
    builder.add_operation("/charts/query", HttpMethod::Post, op);
