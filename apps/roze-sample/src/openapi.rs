...
pub fn document() -> serde_json::Value {
    let mut builder = OpenApiBuilder::new("roze-sample", "0.1.0").description("service group: roze_sample");
    ...
    let op = Operation::new("post_roze_sample_login").tag("roze-sample").request_body("LoginReq").response("200", "OK", "LoginResp");
